...
const globalStyle = {
  ...
  navigationBarTitleText: "Artris Mentor",
...
const b = true, E = "mp-weixin", A = T(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), P = E, C = T('{"address":["127.0.0.1","192.168.1.138"],"servePort":7002,"debugPort":9001,"initialLaunchType":"local","skipFiles":["<node_internals>/**","/Applications/HBuilderX.app/Contents/HBuilderX/plugins/unicloud/**/*.js"]}'), O = T('[{"provider":"aliyun","spaceName":"artris","spaceId":"mp-e2583309-9b4f-42d2-8667-82df46945cb4","clientSecret":"mA9b2VBJJHiSv+eVs4CMIA==","endpoint":"https://api.next.bspapp.com"}]') || [];
let N = "";
try {
  N = "__UNI__GF9A11F1";
} catch (e2) {
