...
function initRuntimeSocketService() {
  const hosts = "127.0.0.1,192.168.1.138";
  const port = "8090";
  const id = "mp-weixin_w7gOl4";
...
const pages = [
  ...
  },
  {
    ...
    style: {
      navigationBarTitleText: "导师库",
      navigationStyle: "custom",
      enablePullDownRefresh: true
    }
  },
  {
    path: "pages/mentor-detail/mentor-detail",
    style: {
...
const b = true, E = "mp-weixin", A = T(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), P = E, C = T('{"address":["127.0.0.1","192.168.1.138"],"servePort":7001,"debugPort":9000,"initialLaunchType":"remote","skipFiles":["<node_internals>/**","/Applications/HBuilderX.app/Contents/HBuilderX/plugins/unicloud/**/*.js"]}'), O = T('[{"provider":"aliyun","spaceName":"artris","spaceId":"mp-e2583309-9b4f-42d2-8667-82df46945cb4","clientSecret":"mA9b2VBJJHiSv+eVs4CMIA==","endpoint":"https://api.next.bspapp.com"}]') || [];
let N = "";
try {
  N = "__UNI__GB15DBD3";
} catch (e2) {
