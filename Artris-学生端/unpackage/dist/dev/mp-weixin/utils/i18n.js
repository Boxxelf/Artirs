...
function getLanguage() {
  try {
    return common_vendor.index.getStorageSync("language") || "zh";
  } catch (e) {
    return "zh";
  }
}
function setLanguage(lang) {
  try {
    ...
    common_vendor.index.__f__("error", "at utils/i18n.js:353", "Failed to save language", e);
  }
}
function t(key, params = {}) {
  ...
  if (typeof value === "string") {
    return value.replace(/\{(\w+)\}/g, (match, key2) => {
      return params[key2] !== void 0 ? params[key2] : match;
    });
  }
  return key;
}
